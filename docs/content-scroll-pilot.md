...
- 按住右侧半透明 ↕ 短手柄上下拖动。常规视口下可见手柄 14×96px，透明触摸区域 30×112px，并与 Android 系统右侧返回手势边缘保持至少 18px 间距；上滑查看下面，反向返回。手指移出手柄仍可连续拖动，到头不换实验。
...
- 透明触摸带由屏幕最右边缘向内移动 18px，并叠加右侧安全区；可见短条仍约 14×96px，透明触摸区仍为 30×112px。
